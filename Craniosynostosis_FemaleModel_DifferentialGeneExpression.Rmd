---
title: "Craniosynostosis RNAseq- Female Model Differential Gene Expression"
...
```{r Load Data}
load("/Volumes/paquette_a/slapehn/CranioRNAseq/Female_CranioRNAseq/Data/Female_CranioRNAseq_VoomAdjustedData.RData")
```
...
write.csv(logcpm_female_all, "/Volumes/paquette_a/slapehn/CranioRNAseq/DEGs/logcpm_female.csv")
```
...
DEGNumbers_Plot <- c(0, 2, 0, 1, 0, 1, 0, 1)
...
Upset_list<-list("Coronal"=Cor_Vec, "Lambdoid"=Lamb_Vec, "Sagittal"=Sag_Vec)
...
write.csv(Fry_FDR_Lambdoid, "/Volumes/paquette_a/slapehn/CranioRNAseq/Female_CranioRNAseq/Pathways/Fry_FDR_Lambdoid_Female.csv")
```
...
write.csv(All_Female_DEGs, "/Volumes/paquette_a/slapehn/CranioRNAseq/Female_CranioRNAseq/DEGs/All_Female_DEGs.csv")
